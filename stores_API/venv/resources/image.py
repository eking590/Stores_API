...
class ImageUpload(Resource):
    ...
    def post(cls):
        ...
        try:
            ...
            basename = image_helper.get_basement(image_path)
            return {"message": gettext("image_uploaded").format(basename)}, 201
        except UploadNotAllowed:
            extension = image_helper.get_extension(data["image"])
            return {"messsage": gettext("image_illegal_extension").format(extension)}, 400 
...
class AvatarUpload(Resource): 
    ...
    def put(cls):
        ...
        try: 
            ...
            basename = image_helper.get_basement(avatar_path)
